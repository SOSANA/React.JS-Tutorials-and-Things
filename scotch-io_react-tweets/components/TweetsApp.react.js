...
module.exports = TweetsApp = React.createClass({
  ...
  // we need to use the componentWillReceiveProps method to make sure that if we
  // mount our component again, that it will receive the state
  componentWillReceiveProps: function(newProps, oldProps){
    this.setState(this.getInitialState(newProps));
  },

  // our client side is where our state changes from UI interaction and socket
  // events, so we need to set up some methods to handle that.
  ...
  componentDidMount: function(){
    ...
    // adding our socket listener for when a tweet is emitted, we call our
    // addTweet method to add it to an unread queue on tweet event emission...
